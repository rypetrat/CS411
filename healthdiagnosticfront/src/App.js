...
function App() {
  ...
  const textRequest = "I am a " + ageInputValue + " year old, " + raceInputValue + " " + sexInputValue + " of height " + heightInputValue + " and weight " + weightInputValue + ". I am feeling unwell and experiencing the following symptoms " + symptomsInputValue + ". I currently take the following medication " + curMedsInputValue + ". EXTREMELY IMPORTANT Please return ONLY a csv list of possible diagnosis's based on this information."
  ...
  try {
    ...
    toBackend(); // Remove await if you want to call this asynchronously
...
// sends a JSON of each data field to the backend to be stored in the database
  ...
  // fetches chatGPT response data from backend
  useEffect(() => {
  ...
  return (
    <div className="App">
      ...
      <header className="App-text">
        ...
        {showWeightInput && <p>Please enter your weight:</p>}
        {showHeightInput && <p>Please enter your height:</p>}
